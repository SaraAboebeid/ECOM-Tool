 ...
 */
const TINTS = {
  // Same palette tiles the console uses, so header and console agree.
  sky: 'px-tile px-tile--nuit',
  amber: 'px-tile px-tile--spring',
  emerald: 'px-tile px-tile--green',
  indigo: 'px-tile px-tile--mantis',
  slate: 'px-tile px-tile--midnight',
} as const;
